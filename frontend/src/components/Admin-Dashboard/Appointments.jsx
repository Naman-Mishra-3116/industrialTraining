          ...
          <table className="min-w-max w-full table-auto border-collapse border border-gray-200">
            <thead>
              <tr className="bg-sky-200 text-gray-800 uppercase text-sm leading-normal">
                <th className="py-3 px-6 text-left border-b border-gray-200">Patient Name</th>
                <th className="py-3 px-6 text-left border-b border-gray-200">Doctor</th>
                <th className="py-3 px-6 text-left border-b border-gray-200">Date</th>
                <th className="py-3 px-6 text-left border-b border-gray-200">Time</th>
            ...
            <tbody className="text-gray-700 text-sm font-light">
              {data.map((item, index) => (
                ...
                >
                  <td className="py-3 px-6 text-left">{item.patientName}</td>
                  <td className="py-3 px-6 text-left">{item.doctorName}</td>
